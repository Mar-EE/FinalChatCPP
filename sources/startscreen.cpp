...
StartScreen::StartScreen(std::shared_ptr<Database> dbPtr, std::shared_ptr<ExtraDB> extraDBPtr, QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::StartScreen)
{
    ...
    ui->loginWidget->setExtraDB(m_extraDBPtr);
...
std::shared_ptr<ExtraDB> StartScreen::getExtraDB() const
{
    return m_extraDBPtr;
}
